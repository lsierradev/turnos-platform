...
// packages/database/migrations aplicadas) para poder probar de verdad la
// constraint `EXCLUDE USING gist` de 001_init_turnos.sql bajo concurrencia.
// No corre como parte de `pnpm test` (jest-integration.json es un config
// separado, igual que jest-e2e.json) y se salta si no hay DATABASE_URL.
